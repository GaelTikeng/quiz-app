      ...
      <div className="grey-sec">
        <div className="grey-section">
          <div className="welcome">
            ...
            <p className="p-tag">
            Welcome to the Quiz App admin panel! Here, you can create, edit, and manage quizzes. You can also view user results and statistics.

Start creating your own quizzes and helping others learn!
            </p>
